...
//import 'package:hive_crud_app/model/transaction.g.dart';
...
class _TransactionPageState extends State<TransactionPage> {
  ...
  void editTransaction(
    ...
    // final box = Boxes.getTransactions();// these 2 lines same as transaction.save()
    // box.put(transaction.key, transaction);//need to init key in transaction model

    transaction.save();// this will persist my object in the local database
  }
